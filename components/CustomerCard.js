...
const CustomerCard = () => {
  return (
    <a href="tel:  +44 80 8599 8705" className="card-link text-decoration-none">
    <div className="customer-card">
      ...
      <a href="tel:+44 80 8599 8705" className="call-btn blinking-btn">
         <FaPhoneVolume />  +44 80 8599 8705
      </a>
